  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        `${API_URL}/api/appointments/create-checkout-session`,
        {
          method: "POST",
          credentials: "include",
          headers: {
      ...
      // OLD FLOW: Direct payment (for backwards compatibility)
        ...
        if (data.payment_required === false) {
          toast.success(
            "Appointment booked successfully! Payment not required.",
          );
        } else {
    ...
    <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-8">
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Please review your appointment details and complete the form below.
        </p>
      </div>
