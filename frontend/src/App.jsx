...
const AnalysisRequestForm = React.lazy(
  () => import("./components/AnalysisRequestForm"),
);
...
const AdminProfile = React.lazy(
  () => import("./dashboard/pages/AdminProfile.jsx"),
);
...
const LineChart = React.lazy(
  () => import("./dashboard/pages/Charts/LineChart"),
);
const BarChart = React.lazy(() => import("./dashboard/pages/Charts/BarChart"));
const NotFound = React.lazy(
  () => import("./dashboard/pages/OtherPage/NotFound"),
);
const BasicTableOne = React.lazy(
...
const AnalysesCalendar = React.lazy(
  () => import("./dashboard/pages/AnalysesCalendar.jsx"),
);
const AppointmentsCalendar = React.lazy(
  () => import("./dashboard/pages/AppointmentsCalendar.jsx"),
);
...
const Laboratories = React.lazy(
  () => import("./dashboard/pages/Laboratories.jsx"),
);
const PatientAnalyses = React.lazy(
  () => import("./dashboard/pages/PatientAnalyses.jsx"),
);
const PatientAppointments = React.lazy(
  () => import("./dashboard/pages/PatientAppointments.jsx"),
);
const LaboratoriesCrud = React.lazy(
  () => import("./dashboard/pages/LaboratoriesCrud.jsx"),
);
const AnalysisTypes = React.lazy(
  () => import("./dashboard/pages/AnalysisTypes.jsx"),
);
const AdminMessaging = React.lazy(
...
const LabCalendarDate = React.lazy(
  () => import("./lab/pages/LabCalendarDate.jsx"),
);
const LabConfirmed = React.lazy(() => import("./lab/pages/LabConfirmed.jsx"));
const LabPendingResult = React.lazy(
  () => import("./lab/pages/LabPendingResult.jsx"),
);
      ...
      <div className="mx-4 sm:mx-[10%]">
        ...
        <Suspense fallback={<LoadingSpinner />}>
          <Routes>
            ...
            />
            <Route
              path="/doctor/therapy/:appointmentId"
              element={
                <ProtectedRoute requireRole="doctor">
                  <DoctorTherapy />
                </ProtectedRoute>
            ...
            />
            <Route
              path="/doctor/therapy-dashboard"
              element={
                <ProtectedRoute requireRole="doctor">
                  <DoctorTherapyDashboard />
                </ProtectedRoute>
              }
            />
            <Route
            ...
            <Route
              path="/laboratory/:labId/request"
              element={<AnalysisRequestForm />}
            />
