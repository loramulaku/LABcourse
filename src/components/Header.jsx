...
const Header = () => {
  return (
    <div className='flex flex-column md:flex-row flex-wrap bg-primary rounded-lg px-6 md-px-10 lg:px-20'>
        {/*--------Left side---------*/}
        <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:md-[-30px]'>
            <p className='text-3xl md:text-4xl lg:text-5xl text-white font-semibold leading-tight md:leading-tight lg:leading-tight'>
                Book Appointment <br>With Trusted Doctors</br>
            </p>
            <div className='flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light'>
                <img  className='w-28' src={assets.group_profiles} alt=""></img>
                <p>Simply browse through our extended list of trusted doctors,<br className='hidden sm:block'></br>schedule your appointment hassle-free</p>
            </div>
